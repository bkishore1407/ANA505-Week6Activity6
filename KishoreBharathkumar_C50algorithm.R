...
## The model uses decision tree to predict the output by saying true or false
## in comparison to the actual values. It has in fact predicted great close to 
## 93% accuracy by splitting the model into test and train datasets.
 
#TASK: What percent of cases were correctly classified?
## 42/45 = 93.33% of data is correctly classified.
