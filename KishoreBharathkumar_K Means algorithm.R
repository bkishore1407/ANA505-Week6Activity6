...
## The K-means clustering model split the data into clusters and predicted
## the type of flower belongs to which cluster. The results were obtained
## in the form of table and classifed under specific cluster cateogires.

#TASK: Accuracy = number of correctly classified/(total classified) = ?
#i.e our model has achieved ?% accuracy!

## Accuracy = 133 / 150 = 0.8666 = 86.66%