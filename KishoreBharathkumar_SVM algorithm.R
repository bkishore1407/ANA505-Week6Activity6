...
## The model was able to clearly distinguish between the 3 type of species
## with a very low misclassification rate of 2.6%. This is also evident from
## the SVM classification plot obtained.

#What is the accuracy rate?
## Accuracy rate --> 
## 1 - Misclassification rate = 1 - 0.02666 = 0.9733
## Accuracy Rate = 97.33%
